...
public class GameTexturePath {
    ...
    private GameTexturePath(){}

    public static final String SHIP_TEXTURE = "playerShip.png";
    ...
    public static final String GOLD_SHIELD = "shield_gold.png";
    public static final String SILVER_SHIELD = "shield_silver.png";
    public static final String BRONZE_SHIELD = "shield_bronze.png";
    public static final String LOSE_SHIELD_SOUND = "core/assets/sounds/lose_shield_sound.ogg";
    public static final String DESTROY_METEOR_SOUND = "core/assets/sounds/destroy_meteor.ogg";
}
