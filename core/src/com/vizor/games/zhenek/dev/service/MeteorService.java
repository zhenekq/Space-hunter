...
public interface MeteorService {
    ...
    int drawMeteors(List<Sprite> meteors, List<Integer> meteorTranslates, Sprite shieldSprite, SpaceShip shipSprite, SpaceHunter game, int index, PlayScreen screen);
